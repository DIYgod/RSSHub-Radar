<template>
    <div class="about">
        <el-main>
            ...
            <div class="content">
                <div class="tip">
                    <p>RSSHub Radar 是 <a target="_blank" href="https://docs.rsshub.app">RSSHub</a> 的衍生项目，她可以帮助你快速发现当前网站自带的 RSS 及支持当前网站的 RSSHub，项目<a target="_blank" href="https://github.com/DIYgod/RSSHub-Radar">采用 MIT 许可开源</a>，使用完全免费，但是随着项目规模的增长，也需要有相应的资金支持才能持续项目的维护与开发</p>
